...
| **Modulation** | **LFO Rate** knob (0.01–20 Hz, log scale) and a **4-slot modulation matrix**; each slot routes a source (LFO or per-voice Env) to a destination (Pitch ±2 st, Cutoff ±3 oct, Resonance ±10 Q, Mix); amount knob is bipolar (−100%…+100%); multiple slots can target the same destination and sum |
